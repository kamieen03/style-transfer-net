...
class encoder3(nn.Module):
    def __init__(self):
        ...
        self.conv2 = nn.Conv2d(3,32,3,1,0)
        ...
        self.conv6 = nn.Conv2d(64,128,3,1,0)
...
class decoder3(nn.Module):
    def __init__(self):
        ...
        self.conv7 = nn.Conv2d(128,64,3,1,0)
        ...
        self.conv10 = nn.Conv2d(32,32,3,1,0)
        self.relu10 = nn.ReLU(inplace=True)

        self.reflecPad11 = nn.ReflectionPad2d((1,1,1,1))
        self.conv11 = nn.Conv2d(32,3,3,1,0)
